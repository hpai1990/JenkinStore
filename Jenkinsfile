...
node{
    stage 'Integration test'
        ...
        junit keepLongStdio: true, testResults: '/child-artifacts/*.xml'
        publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: true, reportDir: 'child-artifacts', reportFiles: 'index.html', reportName: 'Integration Test Report', reportTitles: ''])
    //}    
